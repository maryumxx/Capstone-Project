    ...
    <main>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5 px-4 md:px-20">
        <div className="bg-[#F7F7F7] rounded-lg p-4 flex-1 min-w-[300px]">
          ...
          <div>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore, libero. Quo maxime rerum repudiandae autem laboriosam eum veniam ea tempora. Recusandae corporis sapiente perferendis. Autem ipsam obcaecati nisi eligendi nostrum.</p>
          </div>
        </div>
        <div className="bg-[#F7F7F7] rounded-lg p-4 flex-1 min-w-[300px]">
          <div className="flex justify-between items-center">
